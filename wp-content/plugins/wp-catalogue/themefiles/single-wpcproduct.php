...
<?php echo get_option('inn_temp_head'); ?>	
	 ...
	 $terms	=	get_terms('wpccategories');
		...
		echo '<div class="wp-catalogue-breadcrumb"> <a href="'.$catalogue_page_url.'">Все позиции</a> &gt;&gt; <a href="'.$cat_url.'">'.$tname.'</a>  ' . $pname . '</div>';
		 ?>
...
echo '<div id="wpc-col-1">
		...
		if($count>0){
			echo '<li class="wpc-category"><a href="'. get_option('catalogue_page_url') .'">Все позиции</a></li>';
	...
	?>
        ...
        <h4>Подробности  <?php if($product_price): ?><span class="product-price">Цена: <span><?php echo $product_price; ?></span></span><?php endif; ?></h4>
<article class="post">
